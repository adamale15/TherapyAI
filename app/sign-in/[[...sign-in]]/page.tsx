        ...
        appearance={{
          elements: {
            ...
            socialButtonsBlockButton:
              "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-full font-medium",
            socialButtonsBlockButtonText: "text-gray-700",
            formButtonPrimary:
              "bg-gray-900 hover:bg-gray-800 text-white rounded-full font-semibold shadow-md",
            formFieldInput:
              "bg-gray-100 border-gray-300 text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-400 focus:border-gray-400",
